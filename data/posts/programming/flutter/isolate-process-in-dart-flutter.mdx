...
images: ['/static/images/flutter/isolates_process_dart.png']
draft: false
...
this example, I will use some library. For the network, I'm using [Dio](https://pub.dev/packages/dio), and using [Freezed](https://pub.dev/packages/freezed) to create the models.
