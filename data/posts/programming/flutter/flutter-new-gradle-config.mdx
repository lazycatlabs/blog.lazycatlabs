...
But we need to manage FirebaseOptions to support multiple environments like in my [previous article](https://blog.lazycatlabs.com/posts/programming/flutter/flutter-store-data-environment).
