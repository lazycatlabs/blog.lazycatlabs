...
images:
  [
    'https://github.com/lazycatlabs/blog.lazycatlabs.com-giscus/blob/main/blog-assets/seo-banner/flutter/flutter_showcase.png?raw=true',
  ]
draft: false
...
<div className="aspect-h-9 aspect-w-16">
  <iframe
    type="text/html"
    src="https://www.youtube.com/embed/y07lDPzfVgk?autoplay=0&fs=1&iv_load_policy=3&showinfo=1&rel=1&cc_load_policy=0"
    frameBorder="0"
...
[Source Code](https://github.com/lazycatlabs/flutter-web-portfolio)
