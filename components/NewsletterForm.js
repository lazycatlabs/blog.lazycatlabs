    ...
    <div>
      ...
      <form className="flex flex-col sm:flex-row" onSubmit={subscribe}>
        <div>
          ...
          <input
            autoComplete="email"
            className="focus:ring-primary-600 w-72 rounded-md px-4 focus:border-transparent focus:outline-none focus:ring-2"
            id="email-input"
            name="email"
        ...
        <div className="sm:ml-3·sm:mt-0 mt-2 flex w-full rounded-md shadow-sm">
          <button
            ...
            } focus:ring-primary-600 focus:outline-none focus:ring-2 focus:ring-offset-2`}
            type="submit"
            disabled={subscribed}
          >
