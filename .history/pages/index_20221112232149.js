  ...
  return (
    <>
      ...
      <div className="divide-y">
        <div className="pt-4 md:pt-24 pb-8 space-y-2 md:space-y-5">
                ...
                <article className="space-y-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
                  ...
                  <div className="space-y-3 xl:col-span-3">
                    ...
                    <div className="text-base font-medium leading-6">
                      <button className="group inline-flex items-center h-9 text-sm font-semibold whitespace-nowrap">
                        <Link
                          href={`/blog/${slug}`}
      ...
      {posts.length > MAX_DISPLAY && (
        <div className="flex justify-end text-base font-medium leading-6 py-8">
          <Link
            href="/blog"
            className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400"
